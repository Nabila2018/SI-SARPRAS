    ...
    <div class="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
        <h3 class="text-xs uppercase tracking-wider font-bold text-gray-500 flex items-center gap-2">
            <svg class="w-4 h-4 text-[#114F72]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 01-2-2h2a2 2 0 012 2"/>
            </svg>
