...
<div class="max-w-7xl mx-auto pb-12">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
        <div class="flex items-center gap-4">
            <a href="{{ route('staff.laporan.index') }}" class="p-2 text-gray-500 hover:text-[#114F72] hover:bg-gray-100 rounded-xl transition-colors">
    ...
    <!-- Workflow Timeline -->
    @include('staff.laporan.partials._workflow_timeline')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            @include('staff.laporan.partials._' . $activeTab)
        </div>

        <!-- Sticky Right Sidebar -->
        <div class="lg:col-span-1">
            <div class="sticky top-6">
                @include('staff.laporan.partials._sidebar')
            </div>
        </div>
    </div>
